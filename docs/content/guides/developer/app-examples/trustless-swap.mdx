...
<details>
  <summary>
    Create `src/helpers/create-demo-objects.ts`:
  </summary>
  {@inject: examples/trading/frontend/src/helpers/create-demo-objects.ts}
</details>
...
Locking owned objects is a crucial on-chain action in this application and is very likely to be used all over. Hence, it's beneficial to extract its logic into separated mutating functions to enhance reusability and encapsulation.
...
<details>
  <summary>
    Create `src/hooks/useLockObjectMutation.ts`:
  </summary>
```tsx
...
Unlocking owned objects is another crucial on-chain action in this application and is very likely to be used all over. Hence, it's beneficial to extract its logic into separated mutating functions to enhance reusability and encapsulation.
...
<details>
  ...
  {@inject: examples/trading/frontend/src/mutations/unlock.ts}
</details>
